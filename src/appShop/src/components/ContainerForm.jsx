...
function ContainerForm({
  ...
  return (
    <View style={[styles.searchAnythingMenuParent, styles.searchParentFlexBox]}>
      <View style={styles.searchAnythingMenu}>
        <View style={[styles.searchAnythingMenu1, styles.searchParentFlexBox]}>
          <Image
            style={styles.icon}
            contentFit="cover"
          ...
          />
          <Text
            style={[styles.searchAnythingMenu2, styles.searchAnythingMenu2Typo]}
          >
