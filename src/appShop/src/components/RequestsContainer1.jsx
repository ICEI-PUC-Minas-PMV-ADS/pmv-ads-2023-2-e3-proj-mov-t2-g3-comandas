  ...
  return (
    <View style={styles.frameParent}>
      <View style={styles.solicitaesPendentesParent}>
        ...
        <Text style={[styles.verTodos, styles.verLayout]}>Ver todos</Text>
      </View>
      ...
      <View style={styles.reservasConfirmadasParent}>
        <Text style={[styles.reservasConfirmadas, styles.frameChildPosition]}>
          Reservas confirmadas
        </Text>
        <Text style={[styles.verTodos1, styles.mesaPara3Typo]}>Ver todos</Text>
      </View>
      <View style={styles.frameContainer}>
        <ConfirmedReservationsContainer
          dimensions={require('../assets/vector3@3x.png')}
        />
        <ConfirmedReservationsContainer
          dimensions={require('../assets/vector4@3x.png')}
          propTop={72}
          propTop1="41.16%"
          propBottom="41.16%"
        />
        <ConfirmedReservationsContainer
          dimensions={require('../assets/vector5@3x.png')}
          propTop={145}
          propTop1="41.16%"
          propBottom="41.16%"
        />
