...
function PedidosContainer() {
  return (
    <View style={styles.frameParent}>
      <View style={[styles.pedidosRecentesParent, styles.frameWrapperFlexBox]}>
      ...
      <RecentOrdersContainer1
        dimensionCode={require('../assets/45@3x.png')}
        dimensionCodeImageUrl={require('../assets/451@3x.png')}
        dimensionCodeText={require('../assets/452@3x.png')}
      />
      <Image
        style={styles.frameChild}
        contentFit="cover"
        source={require('../assets/vector-12@3x.png')}
      />
      <View style={[styles.frameWrapper, styles.frameWrapperFlexBox]}>
        <View style={styles.pedidosParaRetiradaParent}>
          <Text style={[styles.pedidosParaRetirada, styles.pedidosTypo]}>
      ...
      <RecentOrdersContainer1
        dimensionCode={require('../assets/453@3x.png')}
        dimensionCodeImageUrl={require('../assets/454@3x.png')}
        dimensionCodeText={require('../assets/455@3x.png')}
        propMarginTop={10}
      />
    </View>
  );
