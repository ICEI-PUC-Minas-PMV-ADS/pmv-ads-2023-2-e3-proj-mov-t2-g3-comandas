        ...
        <View style={[styles.frameGroup, styles.frameFlexBox1]}>
          <View style={[styles.frame1, styles.frameLayout2]}>
            ...
            <View style={[styles.parent, styles.parentSpaceBlock]}>
              <Text style={[styles.text, styles.textClr]}>521</Text>
              <View style={[styles.frame2, styles.frameFlexBox]}>
                <View style={styles.group}>
                  <Image
                    style={styles.icon}
                    contentFit="cover"
                    source={require('../assets/122@3x.png')}
                  />
          ...
          <Image
            ...
            contentFit="cover"
            source={require('../assets/group-48096203@3x.png')}
          />
        </View>
        <View style={[styles.frameGroup, styles.frameFlexBox1]}>
          <View style={[styles.frame3, styles.frameLayout2]}>
            <Text style={styles.totalOrders}>Total Canceled</Text>
            <View style={[styles.container, styles.parentSpaceBlock]}>
              <Text style={[styles.text, styles.textClr]}>128</Text>
              <View style={[styles.frame4, styles.frameFlexBox]}>
                <View style={[styles.frameView, styles.parent2SpaceBlock]}>
                  <Image
                    style={styles.icon}
                    contentFit="cover"
                    source={require('../assets/1221@3x.png')}
                  />
                  <Text style={[styles.text3, styles.textTypo]}>3.2%</Text>
                </View>
              </View>
            </View>
          </View>
          <Image
            style={styles.frameChild}
            contentFit="cover"
            source={require('../assets/group-48096207@3x.png')}
          />
        </View>
        <View style={[styles.frameParent1, styles.frameFlexBox1]}>
          <View style={[styles.frame5, styles.frameLayout1]}>
            ...
            <View style={[styles.parent1, styles.parentLayout]}>
              <Text style={[styles.text4, styles.textClr]}>146</Text>
              <View style={[styles.frame6, styles.frameFlexBox]}>
                <View style={[styles.parent2, styles.parent2SpaceBlock]}>
                  <Image
                    style={styles.icon}
                    contentFit="cover"
                    source={require('../assets/1222@3x.png')}
                  />
                  <Text style={[styles.text5, styles.textTypo]}>1.8%</Text>
                </View>
              </View>
            </View>
          </View>
          <Image
            style={styles.frameChild}
            contentFit="cover"
            source={require('../assets/group-48096204@3x.png')}
          />
        </View>
        <View style={[styles.frameParent1, styles.frameFlexBox1]}>
          <View style={[styles.frame7, styles.frameLayout1]}>
            ...
            <View style={[styles.parent3, styles.parentLayout]}>
              <Text style={[styles.text4, styles.textClr]}>257</Text>
              <View style={[styles.frame2, styles.frameFlexBox]}>
                <View style={styles.group}>
                  <Image
                    style={styles.icon}
                    contentFit="cover"
                    source={require('../assets/1223@3x.png')}
                  />
                  <Text style={[styles.text7, styles.textTypo]}>6.2%</Text>
                </View>
              </View>
            </View>
          </View>
          <Image
            style={styles.frameChild}
            contentFit="cover"
            source={require('../assets/group-48096206@3x.png')}
          />
        </View>
      </View>
        ...
        <View style={[styles.maskGroupWrapper, styles.maskGroupLayout]}>
          <View style={styles.maskGroupLayout}>
            <Image
              ...
              contentFit="cover"
              source={require('../assets/group-48095786@3x.png')}
            />
            <View
              style={[
            ...
            >
              <Text
                style={[styles.estatsticasDoRestaurante, styles.textClr]}
