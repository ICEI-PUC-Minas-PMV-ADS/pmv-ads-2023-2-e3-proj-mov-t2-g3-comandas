  ...
  return (
    <View style={[styles.reservas, styles.reservasFlexBox]}>
      ...
      <View style={[styles.frameParent, styles.reservasFlexBox]}>
        <ContainerForm
          imageDimensions={require('../assets/7@3x.png')}
          imageDimensionsText={require('../assets/notif@3x.png')}
          imageCode={require('../assets/image@3x.png')}
          imageCodeText={require('../assets/47@3x.png')}
        />
