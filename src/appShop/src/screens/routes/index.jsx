  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        options={{ title: '' }}
      />
      <Stack.Screen name="QRCode" component={QRCode} options={{ title: '' }} />
...
function QrCodesStackNavigation() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="QrCodesStack" component={QrCodes} />
      {/* Adicione outras telas aqui conforme necessário */}
    </Stack.Navigator>
  );
}
...
function DrawerNavigation() {
  ...
  return (
    ...
    >
      ...
      <Drawer.Screen
        name="QrCodes"
        component={QrCodesStackNavigation}
        options={() => ({
          drawerLabel: 'QrCodes',
          drawerIcon: ({ focused }) => (
            <MesasIcon fill={focused ? '#ff0000' : 'gray'} />
