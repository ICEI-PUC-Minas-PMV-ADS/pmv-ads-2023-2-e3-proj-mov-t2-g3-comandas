...
function Clientes() {
  return (
    <View style={styles.clientes}>
      <BarraLateral
        dimensions={require('../assets/comandas-degrade-11@3x.png')}
        frameViewWidth={206}
          ...
          <View style={styles.frameContainer}>
            <View style={styles.groupParent}>
              <Image
                ...
                contentFit="cover"
                source={require('../assets/group-48096245@3x.png')}
              />
            ...
            <Image
              ...
              contentFit="cover"
              source={require('../assets/frame-48096288@3x.png')}
            />
          </View>
        ...
        <View style={styles.frameView}>
          ...
          <View style={styles.image9Parent}>
            <Image
              ...
              contentFit="cover"
              source={require('../assets/image-9@3x.png')}
            />
            <Text style={styles.servida}>Servida</Text>
          </View>
          <View style={styles.image7Parent}>
            <View style={styles.image7} />
            <Text style={styles.aguardandoPedido}>Aguardando pedido</Text>
          </View>
      ...
      <View style={styles.frameParent4}>
        <View style={styles.frameParent5}>
          <View style={styles.pedidosRecentesParent}>
            <Text style={styles.pedidosRecentes}>Pedidos recentes</Text>
          ...
          <View style={styles.frameParent6}>
            <View style={styles.rectangleParent}>
              ...
              <Image
                style={styles.icon}
                contentFit="cover"
                source={require('../assets/456@3x.png')}
              />
            ...
            <View style={styles.rectangleParent}>
              ...
              <Image
                style={styles.icon}
                contentFit="cover"
                source={require('../assets/457@3x.png')}
              />
              <View style={styles.eggGordonBlueParent}>
                <Text style={styles.eggGordonBlue}>Egg gordon blue</Text>
            ...
            <View style={styles.rectangleParent}>
              ...
              <Image
                style={styles.icon}
                contentFit="cover"
                source={require('../assets/458@3x.png')}
              />
              <View style={styles.pizzaOrangeHotParent}>
                <Text style={styles.pizzaOrangeHot}>Pizza orange hot</Text>
        ...
        <Image
          ...
          contentFit="cover"
          source={require('../assets/vector-111@3x.png')}
        />
          ...
          <View style={styles.frameParent8}>
            <View style={styles.rectangleParent}>
              ...
              <Image
                style={styles.icon}
                contentFit="cover"
                source={require('../assets/459@3x.png')}
              />
              <View style={styles.noodlesWithPotatoParent}>
                <Text style={styles.noodlesWithPotato}>
                  Noodles with potato
            ...
            <View style={styles.rectangleParent}>
              ...
              <Image
                style={styles.icon}
                contentFit="cover"
                source={require('../assets/4510@3x.png')}
              />
              <View style={styles.eggGordonBlueParent}>
                <Text style={styles.eggGordonBlue}>Egg gordon blue</Text>
                <Text style={styles.items1}>4 items</Text>
            ...
            <View style={styles.rectangleParent}>
              ...
              <Image
                style={styles.icon}
                contentFit="cover"
                source={require('../assets/4511@3x.png')}
              />
              <View style={styles.pizzaOrangeHotParent}>
                <Text style={styles.pizzaOrangeHot}>Pizza orange hot</Text>
                <Text style={styles.items2}>2 items</Text>
