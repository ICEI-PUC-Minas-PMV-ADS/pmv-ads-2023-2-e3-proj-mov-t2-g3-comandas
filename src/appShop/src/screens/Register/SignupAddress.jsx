...
export default function SignupAddress({ navigation, route }) {
  ...
  function handleRegister() {
    if (
      ...
      register({
        ...
        addressInfo: { ...address, number: parseInt(address.number, 10) },
      })
        .then(() => {
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          {inputFields.map((field) => (
            <View key={field.key}>
              <Text style={styles.textLableInput}>{field.label}</Text>
          ...
          <View style={styles.checkbox}>
            ...
            >
              Registrando-se você concorda com os termos e condições.
            </Text>
          </View>
